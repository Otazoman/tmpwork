...
//  （サンプル）ポップアップするカレンダー
  ...
  <html>
	...
	<select style="position: relative; z-index:-1">
		<option selected>111111111111111111111111111111111111111111111111111111１つ目</option>
		<option>２つ目</option>
		<option>３つ目</option>
		<option>4444444444444444444444444444444444444444444444444４つ目</option>
	</select>
...
// テーブルをdivで囲んで上位レイヤに設定(z-indexの値を大きくしておく)
	src1 += '<div style="position:relative;z-index:9999;">\n';
...
// カレンダーと全く同じサイズのIFRAMEを生成し、座標を一致させて下位レイヤに描画する
	src1 += '</div>\n';
	src1 += '<div style="position:absolute;z-index:1000;top:0px;left:0px;">';
	src1 += '<iframe src="" frameborder=0 scrolling=no width=' +this.style.frame_width+ ' height=' +this.style.frame_height+ '></iframe>';
	src1 += '</div>\n';
